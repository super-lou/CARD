...
ASHES$P1.funct = list(VC30=rollmean_center)
ASHES$P1.funct_args = list("Q", k=30)
ASHES$P1.timeStep = "none"
ASHES$P1.keep = TRUE

ASHES$P2.funct = list(VCN30=minNA)
ASHES$P2.funct_args = list("VC30", na.rm=TRUE)
ASHES$P2.timeStep = "year"
ASHES$P2.samplePeriod = c('05-01', '11-30')
ASHES$P2.NApct_lim = 20
ASHES$P2.NAyear_lim = 10

ASHES$P3.funct = list("VCN30-2"=get_Xn)
ASHES$P3.funct_args = list("VCN30", waterType="low")
