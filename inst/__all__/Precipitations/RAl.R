...
CARD$P.variable_en = "RAl"
CARD$P.unit_en = "mm"
CARD$P.name_en = "Cumulative annual liquid precipitation"
...
CARD$P.variable_fr = "RAl"
CARD$P.unit_fr = "mm"
CARD$P.name_fr = "Cumul des précipitations liquides annuelles"
