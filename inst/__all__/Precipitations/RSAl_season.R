...
CARD$P.variable_en = c("RSAl_DJF", "RSAl_MAM", "RSAl_JJA", "RSAl_SON")
CARD$P.unit_en = "mm"
CARD$P.name_en = c("Cumulative daily liquid precipitation of each winter",
...
CARD$P.variable_fr = c("RSAl_DJF", "RSAl_MAM", "RSAl_JJA", "RSAl_SON")
CARD$P.unit_fr = "mm"
CARD$P.name_fr = c("Cumul des précipitations liquides journalières de chaque hiver",
