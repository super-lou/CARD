...
CARD$P.variable_en = "RA"
CARD$P.unit_en = "mm"
CARD$P.name_en = "Cumulative annual total precipitation"
...
CARD$P.variable_fr = "RA"
CARD$P.unit_fr = "mm"
CARD$P.name_fr = "Cumul des précipitations totales annuelles"
