...
CARD$P.unit_fr = "bool"
CARD$P.name_fr = "Test de robustesse à une variation de précipitations"
...
CARD$P.input_vars = "Q_obs, Q_sim, R_obs"
...
CARD$P1.funct = list(BiasA=compute_Biais, RA=mean)
CARD$P1.funct_args = list(list("Q_obs", "Q_sim"), list("R_obs", na.rm=TRUE))
...
CARD$P2.funct_args = list("BiasA", "RA", thresh=0.05)
