...
CARD$P.variable_en = "NSEinv"
CARD$P.unit_en = "without unit"
CARD$P.name_en = "Nash-Sutcliffe Efficiency of the inverse of the data"
...
CARD$P.method_en = "1. no temporal aggregation - inverse of daily data, then NSE"
CARD$P.topic_en = "Flow, Performance"

### French ___________________________________________________________
CARD$P.variable_fr = "NSEinv"
CARD$P.unit_fr = "sans unité"
CARD$P.name_fr = "Coefficient d’efficience de Nash-Sutcliffe de l’inverse des données"
...
CARD$P.method_fr = "1. aucune agrégation temporelle - inverse des données journalières puis NSE"
