...
CARD$P.variable_en = paste0("deltaVCX10_", Horizon)
CARD$P.unit_en = "%"
CARD$P.name_en = paste0("Average change of annual maximum of the 10-day moving average of daily flows between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("deltaVCX10_", Horizon)
CARD$P.unit_fr = "%"
CARD$P.name_fr = paste0("Changement moyen du maximum annuel de la moyenne mobile sur 10 jours des débits journaliers entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P3.funct = list("deltaVCX10_H1"=get_deltaX,
                     "deltaVCX10_H2"=get_deltaX,
                     "deltaVCX10_H3"=get_deltaX)
CARD$P3.funct_args = list(list("VCX10", "date",
                               past=H0, futur=H1,
