...
CARD$P1.funct = list(Q01A=compute_Qp)
...
CARD$P2.funct = list("deltaQ01A_H1"=get_deltaX,
                     "deltaQ01A_H2"=get_deltaX,
                     "deltaQ01A_H3"=get_deltaX)
CARD$P2.funct_args = list(list("Q01A", "date",
                               past=H0, futur=H1,
