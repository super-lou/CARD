...
CARD$P.variable_en = "medQJ_H2"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Median inter-annual flow of middle horizon"
CARD$P.description_en = ""
CARD$P.method_en = ""
CARD$P.topic_en = "Flow, Mean Flows, Intensity"

### French ___________________________________________________________
CARD$P.variable_fr = "medQJ_H2"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Débit médian inter-annuel de l'horizon moyen"
...
CARD$P1.funct = list("medQJ_H2"=median)
