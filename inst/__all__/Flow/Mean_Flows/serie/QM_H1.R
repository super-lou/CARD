...
CARD$P.variable_en = "QM_H1"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Mean monthly discharge of near horizon"
CARD$P.description_en = ""
CARD$P.method_en = ""
CARD$P.topic_en = "Flow, Mean Flows, Intensity"

### French ___________________________________________________________
CARD$P.variable_fr = "QM_H1"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Débit moyen mensuel de l'horizon proche"
