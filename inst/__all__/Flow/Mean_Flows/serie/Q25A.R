...
CARD$P.variable_en = "Q25A"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Third quartile of annual flows"
CARD$P.description_en = "Annual flow with an exceedance probability of 25 % (75th percentile)"
CARD$P.method_en = "1. annual aggregation [01-01, 12-31] - quantile at the exceedance probability of 25 %"
CARD$P.sampling_period_en = "01-01, 12-31"
CARD$P.topic_en = "Flow, Mean Flows, Intensity"

### French ___________________________________________________________
CARD$P.variable_fr = "Q25A"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Troisième quartile des débits annuels"
CARD$P.description_fr = "Débit annuel avec une probabilité de dépassement de 25 % (centile 75 %)"
CARD$P.method_fr = "1. agrégation annuelle [01-01, 31-12] - quantile à la probabilité de dépassement de 25 %"
