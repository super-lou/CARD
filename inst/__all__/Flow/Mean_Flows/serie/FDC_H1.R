...
CARD$P.variable_en = "FDC_H1"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Flow duration curve of near horizon"
...
CARD$P.variable_fr = "CDC_H1"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Courbe des débits classés de l'horizon proche"
