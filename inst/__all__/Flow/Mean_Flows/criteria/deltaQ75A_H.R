...
CARD$P.variable_en = paste0("deltaQ75A_", Horizon)
CARD$P.unit_en = "%"
CARD$P.name_en = paste0("Average change of first quartile of annual flows between the ", Horizon_en, " horizon and historical period")
CARD$P.description_en = "Annual flow with an exceedance probability of 75 % (25th percentile)"
CARD$P.method_en = paste0("1. annual aggregation [01-01, 12-31] - quantile at the exceedance probability of 75 %
...
CARD$P.variable_fr = paste0("deltaQ75A_", Horizon)
CARD$P.unit_fr = "%"
CARD$P.name_fr = paste0("Changement moyen du premier quartile des débits annuels entre l'horizon ", Horizon_fr, " et la période historique")
CARD$P.description_fr = "Débit annuel avec une probabilité de dépassement de 75 % (centile 25 %)"
CARD$P.method_fr = paste0("1. agrégation annuelle [01-01, 31-12] - quantile à la probabilité au dépassement de 75 %
...
CARD$P1.funct = list(Q75A=compute_Qp)
...
CARD$P2.funct = list("deltaQ75A_H1"=get_deltaX,
                     "deltaQ75A_H2"=get_deltaX,
                     "deltaQ75A_H3"=get_deltaX)
CARD$P2.funct_args = list(list("Q75A", "date",
                               past=H0, futur=H1,
