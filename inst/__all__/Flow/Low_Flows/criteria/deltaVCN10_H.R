...
CARD$P.variable_en = paste0("deltaVCN10_", Horizon)
CARD$P.unit_en = "%"
CARD$P.name_en = paste0("Average change of annual minimum of 10-day mean daily discharge between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("deltaVCN10_", Horizon)
CARD$P.unit_fr = "%"
CARD$P.name_fr = paste0("Changement moyen du minimum annuel de la moyenne sur 10 jours du débit journalier entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P3.funct = list("deltaVCN10_H1"=get_deltaX,
                     "deltaVCN10_H2"=get_deltaX,
                     "deltaVCN10_H3"=get_deltaX)
