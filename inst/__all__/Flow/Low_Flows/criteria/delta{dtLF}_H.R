...
CARD$P.variable_en = paste0("delta{dtLF}_", Horizon)
CARD$P.unit_en = "day"
CARD$P.name_en = paste0("Average change of duration of low flows between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("delta{dtBE}_", Horizon)
CARD$P.unit_fr = "jour"
CARD$P.name_fr = paste0("Changement moyen de la durée des basses eaux entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P5.funct = list("delta{dtLF}_H1"=get_deltaX,
                     "delta{dtLF}_H2"=get_deltaX,
                     "delta{dtLF}_H3"=get_deltaX)
CARD$P5.funct_args = list(list("dtLF", "date",
                               past=H0, futur=H1,
