...
CARD$P.variable_en = "med{vLF}"
CARD$P.unit_en = "hm^{3}"
CARD$P.name_en = "Median of low flow deficit volumes"
CARD$P.description_en = "Median of sums of the differences between the 10-day average and the maximum of the VCN10, over the longest sequence below this threshold"
...
CARD$P.variable_fr = "med{vBE}"
CARD$P.unit_fr = "hm^{3}"
CARD$P.name_fr = "Médiane des volumes de déficite des basses eaux"
CARD$P.description_fr = "Médiane des sommes des écarts entre de la moyenne sur 10 jours et le maximum des VCN10, sur la séquence la plus longue sous ce seuil"
...
CARD$P5.funct = list("med{vLF}"=median)
CARD$P5.funct_args = list("vLF", na.rm=TRUE)
