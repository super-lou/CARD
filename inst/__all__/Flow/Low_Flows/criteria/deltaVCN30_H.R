...
CARD$P.variable_en = paste0("deltaVCN30_", Horizon)
CARD$P.unit_en = "%"
CARD$P.name_en = paste0("Average change of annual minimum of 30-day mean daily discharge between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("deltaVCN30_", Horizon)
CARD$P.unit_fr = "%"
CARD$P.name_fr = paste0("Changement moyen du minimum annuel de la moyenne sur 30 jours du débit journalier entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P3.funct = list("deltaVCN30_H1"=get_deltaX,
                     "deltaVCN30_H2"=get_deltaX,
                     "deltaVCN30_H3"=get_deltaX)
CARD$P3.funct_args = list(list("VCN30", "date",
                               past=H0, futur=H1,
