...
CARD$P.variable_en = paste0("deltaQMNA_", Horizon)
CARD$P.unit_en = "%"
CARD$P.name_en = paste0("Average change of annual minimum of monthly flows between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("deltaQMNA_", Horizon)
CARD$P.unit_fr = "%"
CARD$P.name_fr = paste0("Changement moyen du minimum annuel des débits mensuels entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P3.funct = list("deltaQMNA_H1"=get_deltaX,
                     "deltaQMNA_H2"=get_deltaX,
                     "deltaQMNA_H3"=get_deltaX)
CARD$P3.funct_args = list(list("QMNA", "date",
                               past=H0, futur=H1,
