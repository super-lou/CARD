...
CARD$P.variable_en = "VCN30-2"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Annual minimum of 30-day mean daily discharge with a return period of 2 years"
...
3. no temporal aggregation - calculation of the 2-year return period flow using the log-normal distribution"
CARD$P.sampling_period_en = "Month of maximum monthly flows"
CARD$P.topic_en = "Flow, Low Flows, Intensity"

### French ___________________________________________________________
CARD$P.variable_fr = "VCN30-2"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Minimum annuel de la moyenne sur 30 jours du débit journalier de période de retour 2 ans"
...
3. aucune agrégation temporelle - calcul du débit de période de retour 2 ans avec la loi log-normal"
...
CARD$P3.funct_args = list("VCN30", returnPeriod=2, waterType="low")
