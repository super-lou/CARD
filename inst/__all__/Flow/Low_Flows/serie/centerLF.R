...
CARD$P.method_en = "1. no temporal aggregation - 10-day centered moving average (series of VC10)
...
CARD$P.method_fr = "1. aucune agrégation temporelle - moyenne mobile centrée sur 10 jours (série des VC10)
