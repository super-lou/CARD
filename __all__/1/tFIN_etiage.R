...
CARD$P.glose = "Date de la dernière moyenne sur 10 jours sous le maximum des minimums annuels de la moyenne sur 10 jours du débit journalier (fin d'étiage)"
...
CARD$P4.funct = list(tFIN_etiage=apply_threshold)
