...
CARD$P.variable_en = c("meanTA_DJF", "meanTA_MAM",
                       "meanTA_JJA", "meanTA_SON")
CARD$P.unit_en = "°C"
...
CARD$P.variable_fr = c("moyTA_DJF", "moyTA_MAM",
                       "moyTA_JJA", "moyTA_SON")
CARD$P.unit_fr = "°C"
...
CARD$P2.funct = list(meanTA_DJF=mean, meanTA_MAM=mean, meanTA_JJA=mean, meanTA_SON=mean)
CARD$P2.funct_args = list(list("TA_DJF", na.rm=TRUE), list("TA_MAM", na.rm=TRUE), list("TA_JJA", na.rm=TRUE), list("TA_SON", na.rm=TRUE))
