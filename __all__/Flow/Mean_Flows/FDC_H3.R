...
CARD$P.variable_en = "FDC_H3"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Flow duration curve of distant horizon"
...
CARD$P.variable_fr = "CDC_H3"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Courbe des débits classés de l'horizon lointain"
...
CARD$P1.funct = list(FDC_H3_p=compute_FDC_p, FDC_H3_Q=compute_FDC_Q)
