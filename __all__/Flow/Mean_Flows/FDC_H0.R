...
CARD$P.variable_en = "FDC_H0"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Flow duration curve of historical period"
...
CARD$P.variable_fr = "CDC_H0"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Courbe des débits classés de la période historique"
...
CARD$P1.funct = list(FDC_H0_p=compute_FDC_p, FDC_H0_Q=compute_FDC_Q)
CARD$P1.funct_args = list(list(n=1000, isNormLaw=TRUE),
                          list("Q", n=1000, isNormLaw=TRUE))
CARD$P1.period = c("1975-09-01", "2005-08-31")
