...
CARD$P.variable_en = "fQA01"
CARD$P.unit_en = "day.year^{-1}"
CARD$P.name_en = "Annual frequency of exceeding Q01"
CARD$P.description_en = "Annual frequency of exceeding Q > Q01, where Q01 is the flow exceeded 1 % of the time, extracted from the ranked flow curve"
CARD$P.method_en = "1. no temporal aggregation - the quantile at the 1 % exceedance probability is taken as the threshold
...
CARD$P.variable_fr = "fQA01"
CARD$P.unit_fr = "jour.an^{-1}"
CARD$P.name_fr = "Fréquence annuelle de dépassement du Q01"
CARD$P.description_fr = "Fréquence annuelle de dépassement de Q > Q01, Q01 est le débit dépassé 1 % du temps, extrait de la courbe des débits classés"
CARD$P.method_fr = "1. aucune agrégation temporelle - le quantile à la probabilité au dépassement de 1 % est pris comme seuil
...
CARD$P2.funct = list(fQA01=compute_fAp)
