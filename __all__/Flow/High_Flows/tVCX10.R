...
CARD$P.variable_en = "tVCX10"
CARD$P.unit_en = "yearday"
CARD$P.name_en = "Date of the annual maximum of the 10-day mean of daily flow"
...
CARD$P.variable_fr = "tVCX10"
CARD$P.unit_fr = "jour de l'année"
CARD$P.name_fr = "Date du maximum annuel de la moyenne sur 10 jours du débit journalier"
...
CARD$P2.funct = list(tVCX10=which.maxNA)
