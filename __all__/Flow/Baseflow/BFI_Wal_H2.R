...
CARD$P.variable_en = "BFI_Wal_H2"
CARD$P.unit_en = "without unit"
CARD$P.name_en = "Baseflow index of middle horizon (Wallingford)"
...
CARD$P.variable_fr = "BFI_Wal_H2"
CARD$P.unit_fr = "sans unité"
CARD$P.name_fr = "Indice de débit de base de l'horizon moyen (Wallingford)"
...
CARD$P1.funct = list(BF_Wal_H2=BFS)
...
CARD$P2.funct = list(BFI_Wal_H2=get_BFI)
CARD$P2.funct_args = list("Q", "BF_Wal_H2")
