...
CARD$P.variable_en = "BFI_LH_H3"
CARD$P.unit_en = "without unit"
CARD$P.name_en = "Baseflow index of distant horizon (Lyne and Hollick)"
...
CARD$P.variable_fr = "BFI_LH_H3"
CARD$P.unit_fr = "sans unité"
CARD$P.name_fr = "Indice de débit de base de l'horizon lointain (Lyne et Hollick)"
...
CARD$P1.funct = list(BF_LH_H3=BFS)
...
CARD$P2.funct = list(BFI_LH_H3=get_BFI)
CARD$P2.funct_args = list("Q", "BF_LH_H3")
