...
CARD$P.method_en = "1. annual aggregation [09-01, 08-31] - sum of volumes discharged each day for base flow"
...
CARD$P.method_fr = "1. agrégation annuelle [01-09, 31-08] - somme des volumes écoulés chaque jour pour le débit de base"
