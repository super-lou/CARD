...
CARD$P.variable_en = "nVCN10-5_H2"
CARD$P.unit_en = "without unit"
CARD$P.name_en = "Number of years in the middle horizon where VCN10 is superior to VCN10-5 from the historical period"
...
4. no temporal aggregation - counting the number of VCN10 in the middle horizon above VCN10-5_H0"
CARD$P.sampling_period_en = "Month of minimum monthly flows"
CARD$P.topic_en = "Flow, Low Flows, Intensity"

### French ___________________________________________________________
CARD$P.variable_fr = "nVCN10-5_H2"
CARD$P.unit_fr = "sans unité"
CARD$P.name_fr = "Nombre d'années de l'horizon moyen où le VCN10 est supérieur au VCN10-5 de la période historique"
...
4. aucune agrégation temporelle - décompte du nombre de VCN10 de l'horizon moyen au dessus du VCN10-5_H0"
...
CARD$P4.funct = list("nVCN10-5_H2"=apply_threshold)
CARD$P4.funct_args = list("VCN10", lim="VCN10-5_H0", where="<=",
                          what="length", select="all")
CARD$P4.period = c("2041-01-01", "2070-12-31")
