...
CARD$P.name_en = "Median of low flow centers"
CARD$P.description_en = "Median of dates of the annual minimum of 10-day mean flows"
...
CARD$P.name_fr = "Médiane des centres des basses eaux"
CARD$P.description_fr = "Médiane des dates du minimum annuel des débits moyens sur 10 jours"
