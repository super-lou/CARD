...
CARD$P1.sampling_period = list(max, list("Q", na.rm=TRUE))
CARD$P1.NApct_lim = 3
CARD$P1.NAyear_lim = 10

### P2 _______________________________________________________________
CARD$P2.funct = list("deltaQNA_H1"=get_deltaX,
                     "deltaQNA_H2"=get_deltaX,
                     "deltaQNA_H3"=get_deltaX)
CARD$P2.funct_args = list(list("QNA", "date",
                               past=H0, futur=H1,
