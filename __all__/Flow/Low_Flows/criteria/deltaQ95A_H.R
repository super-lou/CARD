...
CARD$P.variable_en = paste0("deltaQ95A_", Horizon)
CARD$P.unit_en = "without unit"
CARD$P.name_en = paste0("Average change of annual flow exceeded 19 years out of 20 between the ", Horizon_en, " horizon and historical period")
CARD$P.description_en = "Annual flow with a exceedance probability of 95 % (5th percentile)"
CARD$P.method_en = paste0("1. annual aggregation [01-01, 12-31] - quantile at the exceedance probability of 95 %
...
CARD$P.variable_fr = paste0("deltaQ95A_", Horizon)
CARD$P.unit_fr = "sans unité"
CARD$P.name_fr = paste0("Changement moyen du débit annuel dépassée 19 années sur 20 entre l'horizon ", Horizon_fr, " et la période historique")
CARD$P.description_fr = "Débit annuel avec une probabilité de dépassement de 95 % (centile 5 %)"
CARD$P.method_fr = paste0("1. agrégation annuelle [01-01, 31-12] - quantile à la probabilité au dépassement de 95 %
...
CARD$P2.funct = list("deltaQ95A_H1"=get_deltaX,
                     "deltaQ95A_H2"=get_deltaX,
                     "deltaQ95A_H3"=get_deltaX)
CARD$P2.funct_args = list(list("Q95A", "date",
                               past=H0, futur=H1,
