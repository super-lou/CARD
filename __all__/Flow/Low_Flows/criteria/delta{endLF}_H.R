...
CARD$P.variable_en = paste0("delta{endLF}_", Horizon)
CARD$P.unit_en = "yearday"
CARD$P.name_en = paste0("Average change of the end of low flows between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("delta{finBE}_", Horizon)
CARD$P.unit_fr = "jour de l'année"
CARD$P.name_fr = paste0("Changement moyen de la fin des basses eaux entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P5.funct = list("delta{endLF}_H1"=get_deltaX,
                     "delta{endLF}_H2"=get_deltaX,
                     "delta{endLF}_H3"=get_deltaX)
CARD$P5.funct_args = list(list("endLF", "date",
                               past=H0, futur=H1,
