...
CARD$P.variable_en = "VCN10_hivernal"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Winter minimum of 10-day mean daily discharge"
...
CARD$P.variable_fr = "VCN10_winter"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Minimum hivernal de la moyenne sur 10 jours du débit journalier"
