...
CARD$P.variable_en = paste0("delta{tVCN10}_winter_", Horizon)
CARD$P.unit_en = "yearday"
CARD$P.name_en = paste0("Average change of the date of the winter minimum of 10-day mean flows between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("delta{tVCN10}_hivernal_", Horizon)
CARD$P.unit_fr = "jour de l'année"
CARD$P.name_fr = paste0("Changement moyen de la date du minimum hivernal des débits moyens sur 10 jours entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P3.funct = list("delta{tVCN10}_winter_H1"=get_deltaX,
                     "delta{tVCN10}_winter_H2"=get_deltaX,
                     "delta{tVCN10}_winter_H3"=get_deltaX)
CARD$P3.funct_args = list(list("tVCN10_winter", "date",
                               past=H0, futur=H1,
                               to_normalise=CARD$P.to_normalise),
                          list("tVCN10_winter", "date",
                               past=H0, futur=H2,
                               to_normalise=CARD$P.to_normalise),
                          list("tVCN10_winter", "date",
                               past=H0, futur=H3,
