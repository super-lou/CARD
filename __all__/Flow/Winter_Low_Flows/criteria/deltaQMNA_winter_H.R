...
CARD$P.variable_en = paste0("deltaQMNA_winter_", Horizon)
CARD$P.unit_en = "without unit"
CARD$P.name_en = paste0("Average change of winter minimum of monthly flows between the ", Horizon_en, " horizon and historical period")
CARD$P.description_en = ""
CARD$P.method_en = paste0("1. monthly aggregation - mean
...
CARD$P.variable_fr = paste0("deltaQMNA_hivernal_", Horizon)
CARD$P.unit_fr = "sans unité"
CARD$P.name_fr = paste0("Changement moyen du minimum hivernal des débits mensuels entre l'horizon ", Horizon_fr, " et la période historique")
CARD$P.description_fr = ""
CARD$P.method_fr = paste0("1. agrégation mensuelle - moyenne
...
CARD$P1.funct = list(QMA_winter=mean)
...
CARD$P2.funct = list(QMNA_winter=minNA)
CARD$P2.funct_args = list("QMA_winter", na.rm=TRUE)
...
CARD$P3.funct = list("deltaQMNA_winter_H1"=get_deltaX,
                     "deltaQMNA_winter_H2"=get_deltaX,
                     "deltaQMNA_winter_H3"=get_deltaX)
CARD$P3.funct_args = list(list("QMNA_winter", "date",
                               past=H0, futur=H1,
                               to_normalise=CARD$P.to_normalise),
                          list("QMNA_winter", "date",
                               past=H0, futur=H2,
                               to_normalise=CARD$P.to_normalise),
                          list("QMNA_winter", "date",
                               past=H0, futur=H3,
