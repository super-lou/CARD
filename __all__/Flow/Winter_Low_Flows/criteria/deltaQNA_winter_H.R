...
CARD$P.variable_en = paste0("deltaQNA_winter_", Horizon)
...
CARD$P.variable_fr = paste0("deltaQNA_hivernal_", Horizon)
...
CARD$P2.funct = list("deltaQNA_winter_H1"=get_deltaX,
                     "deltaQNA_winter_H2"=get_deltaX,
                     "deltaQNA_winter_H3"=get_deltaX)
CARD$P2.funct_args = list(list("QNA_winter", "date",
                               past=H0, futur=H1,
                               to_normalise=CARD$P.to_normalise),
                          list("QNA_winter", "date",
                               past=H0, futur=H2,
                               to_normalise=CARD$P.to_normalise),
                          list("QNA_winter", "date",
                               past=H0, futur=H3,
