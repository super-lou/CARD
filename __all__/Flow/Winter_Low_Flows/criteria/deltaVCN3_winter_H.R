...
CARD$P.variable_en = paste0("deltaVCN3_winter_", Horizon)
CARD$P.unit_en = "without unit"
CARD$P.name_en = paste0("Average change of winter minimum of 3-day mean daily discharge between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("deltaVCN3_hivernal_", Horizon)
CARD$P.unit_fr = "sans unité"
CARD$P.name_fr = paste0("Changement moyen du minimum hivernal de la moyenne sur 3 jours du débit journalier entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P1.funct = list(VC3_winter=rollmean_center)
...
CARD$P2.funct = list(VCN3_winter=minNA)
CARD$P2.funct_args = list("VC3_winter", na.rm=TRUE)
...
CARD$P3.funct = list("deltaVCN3_winter_H1"=get_deltaX,
                     "deltaVCN3_winter_H2"=get_deltaX,
                     "deltaVCN3_winter_H3"=get_deltaX)
CARD$P3.funct_args = list(list("VCN3_winter", "date",
                               past=H0, futur=H1,
                               to_normalise=CARD$P.to_normalise),
                          list("VCN3_winter", "date",
                               past=H0, futur=H2,
                               to_normalise=CARD$P.to_normalise),
                          list("VCN3_winter", "date",
                               past=H0, futur=H3,
