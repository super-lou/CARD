...
CARD$P.variable_en = "QMNA_winter"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Winter minimum of monthly flows"
...
CARD$P.variable_fr = "QMNA_hivernal"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Minimum hivernal des débits mensuels"
