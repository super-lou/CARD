...
CARD$P.variable_en = c("startLF_winter", "endLF_winter",
                       "dtLF_winter", "vLF_winter")
...
CARD$P.variable_fr = c("debutBE_hivernal", "finBE_hivernal",
                       "dtBE_hivernal", "vBE_hivernal")
...
CARD$P4.funct = list(startLF_winter=apply_threshold, endLF_winter=apply_threshold, dtLF_winter=apply_threshold, vLF_winter=compute_VolDef)
CARD$P4.funct_args = list(list("VC10_winter", lim="upLim", where="<=", what="first", select="longest"), list("VC10_winter", lim="upLim", where="<=", what="last", select="longest"), list("VC10_winter", lim="upLim", where="<=", what="length", select="longest"), list("VC10_winter", select="longest", upLim="upLim"))
