...
CARD$P.variable_en = c("startLF_summer", "endLF_summer", "dtLF_summer", "vLF_summer")
...
CARD$P.variable_fr = c("debutBE_estival", "finBE_estival", "dtBE_estival", "vBE_estival")
...
CARD$P4.funct = list(startLF_summer=apply_threshold, endLF_summer=apply_threshold, dtLF_summer=apply_threshold, vLF_summer=compute_VolDef)
CARD$P4.funct_args = list(list("VC10_summer", lim="upLim", where="<=", what="first", select="longest"), list("VC10_summer", lim="upLim", where="<=", what="last", select="longest"), list("VC10_summer", lim="upLim", where="<=", what="length", select="longest"), list("VC10_summer", select="longest", upLim="upLim"))
