...
CARD$P.variable_en = paste0("deltaVCN10_summer_", Horizon)
CARD$P.unit_en = "without unit"
CARD$P.name_en = paste0("Average change of summer minimum of 10-day mean daily discharge between the ", Horizon_en, " horizon and historical period")
...
CARD$P.variable_fr = paste0("deltaVCN10_estival_", Horizon)
CARD$P.unit_fr = "sans unité"
CARD$P.name_fr = paste0("Changement moyen du minimum estival de la moyenne sur 10 jours du débit journalier entre l'horizon ", Horizon_fr, " et la période historique")
...
CARD$P3.funct = list("deltaVCN10_summer_H1"=get_deltaX,
                     "deltaVCN10_summer_H2"=get_deltaX,
                     "deltaVCN10_summer_H3"=get_deltaX)
CARD$P3.funct_args = list(list("VCN10_summer", "date",
                               past=H0, futur=H1,
                               to_normalise=CARD$P.to_normalise),
                          list("VCN10_summer", "date",
                               past=H0, futur=H2,
                               to_normalise=CARD$P.to_normalise),
                          list("VCN10_summer", "date",
                               past=H0, futur=H3,
