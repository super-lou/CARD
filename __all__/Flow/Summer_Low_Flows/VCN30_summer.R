...
CARD$P.variable_en = "VCN30_summer"
CARD$P.unit_en = "m^{3}.s^{-1}"
CARD$P.name_en = "Summer minimum of 30-day mean daily discharge"
...
CARD$P.variable_fr = "VCN30_estival"
CARD$P.unit_fr = "m^{3}.s^{-1}"
CARD$P.name_fr = "Minimum estival de la moyenne sur 30 jours du débit journalier"
