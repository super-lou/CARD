...
CARD$P.variable_en = c("dtCDD_jan", "dtCDD_feb", "dtCDD_mar",
                       "dtCDD_apr", "dtCDD_may", "dtCDD_jun",
                       "dtCDD_jul", "dtCDD_aug", "dtCDD_sep",
                       "dtCDD_oct", "dtCDD_nov", "dtCDD_dec")
CARD$P.unit_en = "day"
...
CARD$P.variable_fr = c("dtCDD_janv", "dtCDD_fevr", "dtCDD_mars",
                       "dtCDD_avril", "dtCDD_mai", "dtCDD_juin",
                       "dtCDD_juil", "dtCDD_aout", "dtCDD_sept",
                       "dtCDD_oct", "dtCDD_nov", "dtCDD_dec")
CARD$P.unit_fr = "jour"
