...
CARD$P.variable_en = c("RAs_jan", "RAs_feb", "RAs_mar", "RAs_apr",
                       "RAs_may", "RAs_jun", "RAs_jul", "RAs_aug",
                       "RAs_sep", "RAs_oct", "RAs_nov", "RAs_dec")
CARD$P.unit_en = "mm"
...
CARD$P.variable_fr = c("RAs_janv", "RAs_fevr", "RAs_mars",
                       "RAs_avril", "RAs_mai", "RAs_juin",
                       "RAs_juil", "RAs_aout", "RAs_sept",
                       "RAs_oct", "RAs_nov", "RAs_dec")
CARD$P.unit_fr = "mm"
