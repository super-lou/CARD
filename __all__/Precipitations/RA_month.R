...
CARD$P.variable_en = c("RA_jan", "RA_feb", "RA_mar", "RA_apr",
                       "RA_may", "RA_jun", "RA_jul", "RA_aug",
                       "RA_sep", "RA_oct", "RA_nov", "RA_dec")
CARD$P.unit_en = "mm"
...
CARD$P.variable_fr = c("RA_janv", "RA_fevr", "RA_mars", "RA_avril",
                       "RA_mai", "RA_juin", "RA_juil", "RA_aout",
                       "RA_sept", "RA_oct", "RA_nov", "RA_dec")
CARD$P.unit_fr = "mm"
