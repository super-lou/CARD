...
CARD$P.variable_en = c("dtRSA20mm_DJF", "dtRSA20mm_MAM",
                       "dtRSA20mm_JJA", "dtRSA20mm_SON")
CARD$P.unit_en = "day"
CARD$P.name_en = c("Number of heavy rain days in winter",
                   "Number of heavy rain days in spring",
                   "Number of heavy rain days in summer",
                   "Number of heavy rain days in autumn")
CARD$P.description_en = c("number of days with at least 20 mm of precipitation (months of December, January, and February)",
                          "number of days with at least 20 mm of precipitation (months of March, April, and May)",
...
CARD$P.variable_fr = c("dtRSA20mm_DJF", "dtRSA20mm_MAM",
                       "dtRSA20mm_JJA", "dtRSA20mm_SON")
CARD$P.unit_fr = "jour"
CARD$P.name_fr = c("Nombre de jours de forte pluie en hiver",
...
CARD$P.description_fr = c("Nombre de jours dans l'hiver avec au moins 20 mm de précipitations (mois de décembre, janvier et février)",
                          "Nombre de jours au printemps avec au moins 20 mm de précipitations (mois de mars, avril et mai)",
...
CARD$P1.funct = list(dtRSA20mm=apply_threshold)
