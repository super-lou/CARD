...
CARD$P2.samplePeriod = list(min, list("Q_obs", na.rm=TRUE))
CARD$P2.keep = "all"
CARD$P2.NApct_lim = 3
...
CARD$P3.samplePeriod = list(min, list("Q_obs", na.rm=TRUE))
CARD$P3.keep = "all"
CARD$P3.NApct_lim = 3
...
CARD$P4.samplePeriod = list(min, list("Q_obs", na.rm=TRUE))
CARD$P4.NApct_lim = 3
