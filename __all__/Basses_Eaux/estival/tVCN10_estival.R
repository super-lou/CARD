CARD$P.variable = "tVCN10_estival"
...
CARD$P.glose = "Centre des basses eaux estivales, date du minimum annuel de la moyenne sur 10 jours du débit journalier"
...
CARD$P2.funct = list(tVCN10_estival=which.minNA)
CARD$P2.funct_args = list("VC10_estival")
