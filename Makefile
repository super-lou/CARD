...
Explore2_proj:
	./manage_CARD.R -d Q -l Explore2_proj [ serie [ QA QA_janv QA_fevr QA_mars QA_avr QA_mai QA_juin QA_juill QA_aout QA_sept QA_oct QA_nov QA_dec QA_DJF QA_MAM QA_JJA QA_SON QA05 QA10 QA50 QA90 QA95 QJXA VCX3 QMNA VCN10 VCN3 ] check [ tQJXA tCEN_etiage_check ] delta [ deltaQA ] ] -w
